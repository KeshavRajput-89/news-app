  ...
  <div class="container ">
    ...
    <div class="row">
      ...
      <div class="col-md-8 my-4 ">
            <div class="container  custom-shadow-container-netwrok">
              <div class="row py-2 px-4">
                  <div class="col "><img src="images/quality packing.jpg" class="rounded client-image" width="100%" height="300px"></div>
                  <div class="col"><img src="images/office shifting.jpg" class="rounded client-image" width="100%" height="300px"></div>
              </div>
              <div class="row py-2 px-4">
                  <div class="col"><img src="images/quality packing.jpg" class="rounded client-image" width="100%" height="300px"></div>
                  <div class="col"><img src="images/office shifting.jpg" class="rounded client-image" width="100%" height="300px"></div>
